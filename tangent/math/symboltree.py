...
##        return self.root.get_symbols()
    ...
    def parse_from_slt(cls, tree_string):
        ...
        root = cls.__create_tree_from_string(tree_string)
    ...
    def __create_tree_from_string(cls, tree_substring):
        ...
        root = MathSymbol(label, current_next, current_above, current_below,
    ...
    def get_dot_string(self, highlight=None, unified=None, generic=False):
        ...
        self.root.get_dot_strings('', rank_strings, node_names, node_strings, edge_strings, highlight, unified, generic)
    ...
    def save_as_dot(self, output_filename, highlight=None, unified=None, generic=False):
        dot_str = self.get_dot_string(highlight, unified, generic)
